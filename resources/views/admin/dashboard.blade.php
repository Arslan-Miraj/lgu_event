...
@section('main_content')
    ...
    <!-- Top Bar -->
      <div class="my-6">
        <h2 class="text-2xl font-bold text-lime-400 mb-6 text-center">Welcome, <span>Super Admin</span></h2>
      </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
      ...
      <a href="/add_society" class="bg-gradient-to-br from-green-600 to-emerald-800 rounded-lg shadow-md p-6 hover:shadow-xl transition transform hover:scale-105">
